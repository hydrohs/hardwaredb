...
urlpatterns = [
    ...
    path('systems/custom/all', SystemList.as_view(), name="systems_all"),
    path('systems/micros/all', MicroList.as_view(), name="micros_all"),
    path('systems/proprietary/all', ProprietaryList.as_view(), name="prop_all"),
    path('systems/custom/<int:pk>', SystemDetail.as_view(), name="system_detail"),
    path('systems/micros/<int:pk>', MicroDetail.as_view(), name="micro_detail"),
    path('systems/proprietary/<int:pk>', ProprietaryDetail.as_view(), name="micro_detail"),
    path('sbc/all', SBCList.as_view(), name="sbc_all"),
    path('sbc/<int:pk>', SBCDetail.as_view(), name="sbc_detail"),
