...
urlpatterns = [
    ...
    path('systems/all', SystemList.as_view(), name="systems_all"),
    path('micros/all', MicroList.as_view(), name="micros_all"),
    path('prop/all', PropList.as_view(), name="prop_all"),
    path('systems/<int:pk>', SystemDetail.as_view(), name="system_detail"),
    path('microprop/<int:pk>', MicroPropDetail.as_view(), name="microprop_detail"),
